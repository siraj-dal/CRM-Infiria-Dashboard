...
export const env: Env = cleanEnv(
	process.env,
	{
		...
		DEMO_SUPER_ADMIN_EMAIL: str({ default: 'admin@infiria.com' }),
		DEMO_SUPER_ADMIN_PASSWORD: str({ default: 'admin' }),

		DEMO_ADMIN_EMAIL: str({ default: 'local.admin@infiria.com' }),
		DEMO_ADMIN_PASSWORD: str({ default: 'admin' }),

		DEMO_EMPLOYEE_EMAIL: str({ default: 'employee@infiria.com' }),
		...
		PLATFORM_LOGO: str({
			default: 'assets/images/logos/logo_Infiria.svg'
		}),
