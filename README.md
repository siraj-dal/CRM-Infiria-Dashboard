...
-   You can login with `employee@infiria.com` and password `123456` to check Employee-related functionality in Gauzy UI or to run Desktop Timer from an "Employee" perspective (such a user is an Employee and can track time).
...
-   Login with email `employee@infiria.com` and password: `123456` for Employee user.
-   Enjoy!
...
**Ever**® is a registered trademark of [Infiria Pvt. LTD](https://ever.co).
**Ever® Demand™**, **Ever® Gauzy™**, **Ever® Teams™**, **Ever® Recu™**, **Ever® Clokr™** and **Ever® OpenSaaS™** are all trademarks of [Infiria Pvt. LTD](https://ever.co).

The trademarks may only be used with the written permission of Infiria Pvt. LTD. and may not be used to promote or otherwise market competitive products or services.
...
#### © 2025 Infiria AI Private Limited. All rights reserved.
