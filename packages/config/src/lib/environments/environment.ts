...
export const environment: IEnvironment = {
	...
	appIntegrationConfig: {
		...
		appLogo: process.env.APP_LOGO || `${process.env.CLIENT_BASE_URL}/assets/images/logos/logo_Infiria.png`,
		...
		companyName: process.env.COMPANY_NAME || 'Infiria Pvt. LTD'
	},

	demo: process.env.DEMO === 'true' ? true : false,

	demoCredentialConfig: {
		superAdminEmail: process.env.DEMO_SUPER_ADMIN_EMAIL || `admin@infiria.com`,
		superAdminPassword: process.env.DEMO_SUPER_ADMIN_PASSWORD || `admin`,
		adminEmail: process.env.DEMO_ADMIN_EMAIL || `local.admin@infiria.com`,
		adminPassword: process.env.DEMO_ADMIN_PASSWORD || `admin`,
		employeeEmail: process.env.DEMO_EMPLOYEE_EMAIL || `employee@infiria.com`,
